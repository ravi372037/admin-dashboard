  ...
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="{{ route('admin.dashboard') }}">
        <svg fill="#000000" width="60" height="60" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{ Route::is('admin.password.form') ? 'active' : '' }}"><a class="nav-link " href="{{ route('admin.password.form')}}"><i class="fas fa-key"></i><span>Change Password</span></a></li>
